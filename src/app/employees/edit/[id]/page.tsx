...
export default function EditEmployeePage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const fetchEmployeeData = async (employeeId: string) => {
        try {
            ...
            alert("Enposib pou chaje done anplwaye yo / Impossible de charger les données de l'employé");
            setLoading(false);
        }
    };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        try {
            // Voye demann lan pou mete ajou (PUT)
            // Envoyer la requête de mise à jour (PUT)
    ...
    return (
        <div className={styles.container}>
            <div className={styles.formCard}>
                <h2 className={styles.title}>Modifier les informations de l'employe {formData.nom} {formData.prenom}</h2>
                <form onSubmit={handleSubmit} className={styles.form}>
                    ...
                    <div className={styles.section}>
                        ...
                        <div className={styles.row}>
                            <div className={styles.group}>
                                <label>Poste </label>
                                <select multiple name="postes" value={formData.postes.map(String)} onChange={(e) => handleMultiSelectChange(e, 'postes')} className={styles.selectMultiple}>
                            ...
                            <div className={styles.group}>
                                ...
                                <select multiple name="type_employes" value={formData.type_employes.map(String)} onChange={(e) => handleMultiSelectChange(e, 'type_employes')} className={styles.selectMultiple}>
                        ...
                        <div className={styles.row}>
                            <div className={styles.group}>
                                ...
                                <select multiple name="direction_generales" value={formData.direction_generales.map(String)} onChange={(e) => handleMultiSelectChange(e, 'direction_generales')} className={styles.selectMultiple}>
                            ...
                            <div className={styles.group}>
                                ...
                                <select multiple name="structures" value={formData.structures.map(String)} onChange={(e) => handleMultiSelectChange(e, 'structures')} className={styles.selectMultiple}>
                        ...
                        <div className={styles.row}>
                            <div className={styles.group}>
                                ...
                                <select multiple name="directions" value={formData.directions.map(String)} onChange={(e) => handleMultiSelectChange(e, 'directions')} className={styles.selectMultiple}>
                            ...
                            <div className={styles.group}>
                                <label>Service</label>
                                <select multiple name="services" value={formData.services.map(String)} onChange={(e) => handleMultiSelectChange(e, 'services')} className={styles.selectMultiple}>
                        ...
                        <div className={styles.row}>
                            <div className={styles.group}>
                                ...
                                <select multiple name="niveau_etudes" value={formData.niveau_etudes.map(String)} onChange={(e) => handleMultiSelectChange(e, 'niveau_etudes')} className={styles.selectMultiple}>
                    ...
                    <div className={styles.actions}>
                        ...
                        <button type="submit" className={styles.submitBtn}>Modifier </button>
                    </div>
                </form>
            </div>
        </div>
